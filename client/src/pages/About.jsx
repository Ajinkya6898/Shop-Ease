  ...
  return (
    <>
      <Container hasPageActionBar={true}>
        <PageActionContainer pageHeading="About Us" />
      </Container>
      <Container>
        <p className="text-lg text-center text-gray-700 leading-relaxed">
          Welcome to{" "}
          <span className="font-semibold text-brand-600">ShopEase </span> , your
          ultimate online shopping hub! We bring you the best shopping
          experience with a vast selection of products, unbeatable deals, and
          top-notch service.
        </p>
