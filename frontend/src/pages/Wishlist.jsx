            ...
            >
              ...
              <div className="flex mt-5 space-x-3">
                <button
                  ...
                  className="flex items-center space-x-2 bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-4 py-2 rounded-full font-semibold shadow-md hover:from-blue-600 hover:to-indigo-600 transition"
                >
                  <FaShoppingCart /> <span>Move to Cart</span>
                </button>
                <button
                  onClick={() => removeFromWishlist(item.id)}
                  className="flex items-center space-x-2 bg-gradient-to-r from-red-500 to-pink-500 text-white px-4 py-2 rounded-full font-semibold shadow-md hover:from-red-600 hover:to-pink-600 transition"
                >
